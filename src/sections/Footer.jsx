  ...
  return (
    <footer className="max-container">
      ...
      >
        ...
        leading-7 font-montserrat text-white-400 sm:max-w-sm"
          >
            Get sheos ready for the new term at your nearest Nike store. Find
            the perfect size in Store.Get Rewards
          </p>
          <div className="flex items-center gap-5 mt-8 ">
            {socialMedia.map((icon, index) => (
             ...
             bg-white rounded-full w-12 h-12"
              >
          ...
          {footerLinks.map((section) => (
            <div key={section}>
              <h4
               ...
               leading-normal font-medium mb-6 text-2xl"
              >
                {section.title}
              </h4>
              <ul>
