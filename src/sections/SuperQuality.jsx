  ...
  return (
    ...
    >
      <div className="flex flex-1 flex-col" >
        ...
        info-text'>Ensuring premium comfort and style,our meticulously crafted footwear is designed
           to elevate your experience, providing you with 
           unmatched quality,innovation,and a touch of elegance style.
        </p>
      ...
      <div className="flex- flex-1 justify-center items-center">
        <img alt='sheos8' src={shoe8} width={570} height={522} className="object-contain"/>
      </div>
    </section>
  );
};
